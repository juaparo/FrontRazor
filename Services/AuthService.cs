 ...
 *
 * 2. AUTORIZACION = Â¿Que puedes hacer?
 ...
 *
 * 3. ENCRIPTACION = Â¿Como se protege?
 ...
 *
 * PROCESO COMPLETO PASO A PASO (VERSION ACTUAL â€” ConsultasController):
 * =====================================================================
 ...
 *
 * FORMA ANTERIOR (sin ConsultasController â€” 5 llamadas HTTP separadas):
 * =====================================================================
...
{
    // â”€â”€ Propiedades publicas (se usan en las paginas Razor) â”€â”€
    ...
    // â”€â”€ Dependencias privadas â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    ///
    /// No se usa para CRUD (crear registros) â€” solo para autenticar.
    /// </summary>
    ...
    public async Task<(bool ok, string msg)> Login(string email, string contrasena)
    {
        try
        {
            // â”€â”€ PASO 1: AUTENTICACION (Â¿Quien eres?) â”€â”€
            ...
            // â”€â”€ PASO 2: AUTORIZACION (Â¿Que puedes hacer?) â”€â”€
            ...
            // â”€â”€ PASO 3: ENCRIPTACION (guardar sesion protegida) â”€â”€
    ...
    private async Task CargarDatosRolesYRutas(string email)
    {
        ...
        try
        {
            // â”€â”€ Paso 1: Descubrir nombres de FK/PK de la estructura â”€â”€
            ...
            // â”€â”€ Paso 2: Armar la consulta SQL dinamicamente â”€â”€
...
WHERE u.{pkUsuario} = @email";
            ...
            // â”€â”€ Paso 3: Ejecutar la consulta via ConsultasController â”€â”€
            // POST /api/consultas/ejecutarconsultaparametrizada
            ...
            // â”€â”€ Paso 4: Extraer roles y rutas de los resultados â”€â”€
            ...
            // â”€â”€ Paso 5: Cargar nombre del usuario (campo opcional) â”€â”€
